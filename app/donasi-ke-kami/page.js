    ...
    <>
      ...
      <div className="container ">
        ...
        <p className="text-slate-600 text-md pt-4 w-full font-medium">
          <span className="font-bold">Ensoft ID</span> adalah proyek berita yang
          berdedikasi untuk memberikan informasi yang menarik dan relevan,
          disajikan dengan kemudahan dan kejelasan seperti media sosial. <br />
      ...
      <p className="text-slate-500 text-md w-full font-semibold text-center mb-2 container">
